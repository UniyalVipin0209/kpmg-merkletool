...
class FullLayout3 extends Component { 
    ...
    render(){
        ...
        return  <div className='general-layout'>
                    <div className='gn-layout-header'>
                        <div className='gn-ly-header-left' onClick={this.handleRoute}>
                        ...
                        <div className='gn-ly-header-middle'>
                            ...
                            <label onClick={() => this.handleRedirct('Kccq_questionire')}>KCCQ Calculator</label>
                            <label onClick={() => this.handleRedirct('GFR_Calculation')}>e-GFR Calculation</label>
                            <label onClick={() => this.handleRedirct('Guide')}>Management Guide</label>
                        </div>
                        ...
                        {this.state.toggleState === true &&
                                <div className='toggle-comp' ref={this.setWrapperRef}>
                                    <ul>
                                        ...
                                        <li onClick={() => this.handleRedirct('Kccq_questionire')}>KCCQ Calculator</li>
                                        <li onClick={() => this.handleRedirct('GFR_Calculation')}>e-GFR Calculation</li>
                                        <li onClick={() => this.handleRedirct('Guide')}>Management Guide</li>
